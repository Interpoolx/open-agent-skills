...
All notable changes to agentic-skills will be documented in this file.
...
- **NEW COMMAND:** `agentic-skills serve` - Start local web server for browsing skills
...
- **NEW COMMAND:** `agentic-skills create [name]` - Scaffold new skills interactively
...
#### ✅ Validation System
- **NEW COMMAND:** `agentic-skills validate [path]` - Validate skill format and quality
...
- 📦 **NPM:** https://www.npmjs.com/package/agentic-skills
- 💻 **GitHub:** https://github.com/Interpoolx/agentic-skills
- 📚 **Docs:** https://github.com/Interpoolx/agentic-skills#readme
- 🐛 **Issues:** https://github.com/Interpoolx/agentic-skills/issues
