...
[Report Bug](https://github.com/Interpoolx/agentic-skills/issues/new?labels=bug)
...
[Request Feature](https://github.com/Interpoolx/agentic-skills/issues/new?labels=feature)
...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/Interpoolx/agentic-skills
...
git remote add upstream https://github.com/Interpoolx/agentic-skills.git
...
- [ ] Validated with `npx agentic-skills validate`
...
```bash
# 1. Create skill
npx agentic-skills create my-skill

# 2. Develop & test
# ... edit SKILL.md & marketplace.json ...

# 3. Validate
npx agentic-skills validate ./my-skill

# 4. Test locally
npx agentic-skills install ./my-skill

# 5. Submit
npx agentic-skills submit ./my-skill
```
...
- **GitHub Issues**: [Ask a question](https://github.com/Interpoolx/agentic-skills/issues/new)
- **Discussions**: [Community chat](https://github.com/Interpoolx/agentic-skills/discussions)
...
Thank you for making Agentic-Skills better! 💜
