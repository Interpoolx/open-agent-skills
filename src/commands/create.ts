...
export async function createSkill(skillName?: string) {
    console.log(chalk.cyan(`\n🚀 ${CLI_BRANDING.brand_name} Skill Creator - Scaffold a new skill\n`));
    ...
    console.log(chalk.white(`  3. npx ${CLI_BRANDING.brand_lower_name} validate`));
    console.log(chalk.white(`  4. npx ${CLI_BRANDING.brand_lower_name} install . --symlink (for testing)`));
...
npx ${CLI_BRANDING.brand_lower_name} install ${data.name}

# Install from local directory
npx ${CLI_BRANDING.brand_lower_name} install . --symlink
\`\`\`
