...
export async function initProject(options: InitOptions = {}): Promise<void> {
    console.log(chalk.cyan.bold(`\n🚀 ${CLI_BRANDING.brand_name} - Project Initialization\n`));
    ...
    console.log(chalk.gray(`  1. Browse skills: npx ${CLI_BRANDING.brand_lower_name} list --registry`));
    console.log(chalk.gray(`  2. Install skill: npx ${CLI_BRANDING.brand_lower_name} install <skill-name>`));
    console.log(chalk.gray(`  3. Sync AGENTS.md: npx ${CLI_BRANDING.brand_lower_name} sync`));
    console.log(chalk.gray(`  4. Run diagnostics: npx ${CLI_BRANDING.brand_lower_name} doctor`));
    console.log('');
}
...
This project uses [${CLI_BRANDING.brand_name}](https://github.com/${CLI_BRANDING.github_org}/${CLI_BRANDING.github_repo}) for AI agent skill management.

## Available Skills

<!-- SKILLS_TABLE_START -->
<!-- Run 'npx ${CLI_BRANDING.brand_lower_name} sync' to populate this section -->
No skills installed yet. Install skills with: \`npx ${CLI_BRANDING.brand_lower_name} install <skill-name>\`
<!-- SKILLS_TABLE_END -->
...
npx ${CLI_BRANDING.brand_lower_name} list

# Install a skill
npx ${CLI_BRANDING.brand_lower_name} install <skill-name>

# Update AGENTS.md
npx ${CLI_BRANDING.brand_lower_name} sync

# Read a skill (for AI agents)
npx ${CLI_BRANDING.brand_lower_name} read <skill-name>
\`\`\`
