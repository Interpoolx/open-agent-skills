...
function detectCursor(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🖱️',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --cursor`
    };
}
...
function detectVSCodeCopilot(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🤖',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --copilot`
    };
}
...
function detectClaudeCode(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🧠',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --claude`
    };
}
...
function detectWindsurf(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🏄',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --windsurf`
    };
}
...
function detectAider(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🔧',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --aider`
    };
}
...
function detectGeminiCLI(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '💎',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --gemini`
    };
}
...
function detectOpenCode(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '📂',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --opencode`
    };
}
...
function detectCodexCLI(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🤯',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --codex`
    };
}
...
function detectAmp(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '⚡',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --amp`
    };
}
...
function detectGoose(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🪿',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --goose`
    };
}
...
function detectLetta(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🧠',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --letta`
    };
}
...
function detectTrae(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🎯',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --trae`
    };
}
...
function detectQoder(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🔷',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --qoder`
    };
}
...
function detectCodeBuddy(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '👯',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --codebuddy`
    };
}
...
function detectAntigravity(home: string, project: string): DetectedAgent {
    ...
    return {
        ...
        icon: '🚀',
        installCommand: `npx ${CLI_BRANDING.brand_lower_name} export --antigravity`
    };
}
...
function generateRecommendations(
    ...
    if (!hasSkillsDir) {
        recommendations.push(`💡 Run \`npx ${CLI_BRANDING.brand_lower_name} init\` to set up skill directories.`);
    }

    if (!hasAgentsMd && installedSkillsCount > 0) {
        recommendations.push(`💡 Run \`npx ${CLI_BRANDING.brand_lower_name} sync\` to generate AGENTS.md for AI agents.`);
    }
    ...
    if (installedSkillsCount === 0) {
        recommendations.push(`💡 Run \`npx ${CLI_BRANDING.brand_lower_name} list --registry\` to browse available skills.`);
    }
    ...
    if (detectedAgents.length > 0 && installedSkillsCount > 0) {
        ...
        if (unexportedAgents.length > 0) {
            recommendations.push(`💡 Run \`npx ${CLI_BRANDING.brand_lower_name} export --all\` to sync skills to all ${unexportedAgents.length} detected agent(s).`);
        }
    }
